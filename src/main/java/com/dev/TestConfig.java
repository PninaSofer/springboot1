...
public class TestConfig {
    ...
    public SessionFactory sessionFactory() throws Exception {
        ...
        configuration.addAnnotatedClass(AssociationObject.class);
        configuration.addAnnotatedClass(UserAssociation.class);
        configuration.addAnnotatedClass(StoreObject.class);
        configuration.addAnnotatedClass(StoreAssociation.class);
